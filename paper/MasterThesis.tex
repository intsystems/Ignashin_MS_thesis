...
\graphicspath{{thesis_assets/figures/}}
...
\newcommand{\ProgramName}{03.04.01 Прикладные математика и физика}
\newcommand{\ThesisTitle}{Frank--Wolfe algorithm in machine learning}
...
\input{thesis_sections/frontpage}
...
\input{thesis_sections/notation}
\input{thesis_sections/annotation}
\input{thesis_sections/introduction}
\input{thesis_sections/fw_modifications}
\input{thesis_sections/cfw_ml}
\input{thesis_sections/scfw}
\input{thesis_sections/dbcfw}
\input{thesis_sections/conclusion}
\input{thesis_sections/bibliography}
